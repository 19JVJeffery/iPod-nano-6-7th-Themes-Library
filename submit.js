...
form.addEventListener("submit", async (event) => {
  ...
  if (!ipswUrl) {
    setStatus("Please provide a direct IPSW URL.", true);
    return;
  }
  if (!ipswUrl.toLowerCase().includes(".ipsw")) {
    setStatus("Your IPSW URL should point directly to an .ipsw file.", true);
    return;
  }
  ...
  setStatus("Opening GitHub issue form in a new tab...");
